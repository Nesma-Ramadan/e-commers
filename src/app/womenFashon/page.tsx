...
import { getAllBrands, getWomenFashonProducts } from '../action/GetData.action'
...
export default async function WomenFashonPage() {

  const allProducts = await getWomenFashonProducts();
